...
console.log(media(840, 11));

// Solução do desafio na plataforma

let line = gets().split(" ");
let X = parseInt(line[0]); // array na posição 0, ou seja na linha 1
let Y = parseInt(line[1]); // array na posição 1
let divisao = parseFloat(X / Y).toFixed(2); // divisão e fixando 2 casas decimais
console.log(divisao);
